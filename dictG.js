exports.dictG = {
  ...
  GLOTTOCHRONOLOGICAL: {
    MEANINGS: {
      '1': [
        'Adjective',
        'pertaining to the study of the evolution of languages from a common source',
        [],
        [
  ...
  GUTSY: {
    MEANINGS: {
      '1': [
        'Adjective',
        'marked by courage and determination in the face of difficulties or danger; robust and uninhibited; it was a gutsy thing to do"',
        [],
        [
